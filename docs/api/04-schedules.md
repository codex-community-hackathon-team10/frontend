...
주간 반복 수업을 등록·수정·삭제하고, 평일 11:00~15:00의 점심 공강을 조회한다. 상대 사용자에게는 이 문서의 수업 리소스를 절대 노출하지 않는다.
...
## PATCH `/users/me/classes/{classId}`
...
## DELETE `/users/me/classes/{classId}`
...
## POST `/users/me/schedule-imports` `[선택]`
...
## POST `/users/me/schedule-imports/{importId}/confirm` `[선택]`
